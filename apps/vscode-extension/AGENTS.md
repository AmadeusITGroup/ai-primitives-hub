...
This package ships the AI Primitives Hub extension. `src/extension.ts` activates it; adapters retrieve source data, services own business logic, commands expose VS Code actions, and UI provides the marketplace and tree view.
